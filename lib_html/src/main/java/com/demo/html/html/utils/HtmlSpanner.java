...
import com.demo.html.html.exception.ParsingCancelledException;
import com.demo.html.html.handlers.FontHandler;
import com.demo.html.html.handlers.HeaderHandler;
import com.demo.html.html.handlers.HorizontalRuleHandler;
import com.demo.html.html.handlers.LinkHandler;
import com.demo.html.html.handlers.ListItemHandler;
import com.demo.html.html.handlers.MonoSpaceHandler;
import com.demo.html.html.handlers.NetImageHandler;
import com.demo.html.html.handlers.NewLineHandler;
import com.demo.html.html.handlers.PreHandler;
import com.demo.html.html.handlers.StrikeThroughHandler;
import com.demo.html.html.handlers.StyleNodeHandler;
import com.demo.html.html.handlers.StyledTextHandler;
import com.demo.html.html.handlers.SubScriptHandler;
import com.demo.html.html.handlers.SuperScriptHandler;
import com.demo.html.html.handlers.UnderlineHandler;
import com.demo.html.html.handlers.attributes.AlignmentAttributeHandler;
import com.demo.html.html.handlers.attributes.BorderAttributeHandler;
import com.demo.html.html.handlers.attributes.StyleAttributeHandler;
import com.demo.html.html.style.Style;
import com.demo.html.html.style.StyleValue;
import com.demo.html.htmlcleaner.CleanerProperties;
import com.demo.html.htmlcleaner.ContentNode;
import com.demo.html.htmlcleaner.HtmlCleaner;
...
public class HtmlSpanner {
    ...
    public HtmlSpanner(Html.ImageGetter imageGetter) {
        this(createHtmlCleaner(), new SystemFontResolver(), imageGetter);
    }
    ...
    public HtmlSpanner(HtmlCleaner cleaner, FontResolver fontResolver, Html.ImageGetter imageGetter) {
        this.htmlCleaner = cleaner;
        this.fontResolver = fontResolver;
        this.handlers = new HashMap<String, TagNodeHandler>();
    ...
    private void registerBuiltInHandlers() {
        NetImageHandler imageHandler = new NetImageHandler(imageGetter);
        registerHandler("img", imageHandler);
        registerHandler("width", imageHandler);
        registerHandler("height", imageHandler);
        ...
        TagNodeHandler leftHandler = new StyledTextHandler(new Style().setTextAlignment(Style.TextAlignment.LEFT));
        registerHandler("left", leftHandler);

        TagNodeHandler rightHandler = new StyledTextHandler(new Style().setTextAlignment(Style.TextAlignment.RIGHT));
        registerHandler("right", rightHandler);
